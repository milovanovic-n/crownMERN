...
const AnimatedHeart = () => {
  ...
  return (
    <div>
      <AnimatedHeartBtn type="button" MyActive={isOnWishlist} onClick={() => toggleIsOnWishlist()}>
        ...
        <SmallHeart MyActive={isOnWishlist} CordinateX={generateCoordinates()} CordinateY={generateCoordinates()} />
        <SmallHeart MyActive={isOnWishlist} CordinateX={generateCoordinates()} CordinateY={generateCoordinates()} />
        <SmallHeart MyActive={isOnWishlist} CordinateX={generateCoordinates()} CordinateY={generateCoordinates()} />
      </AnimatedHeartBtn>
    </div>
